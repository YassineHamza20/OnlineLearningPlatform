                ...
                test = (
                    <div key={day} className={cellClass}>
                        ...
                        <div className="flex flex-col items-center justify-center space-y-2">
                            ...
                            <div className={`text-xs p-1 border max-w-full truncate text-button2 bg-lightButton2 border-button2 rounded-xl`}>
                                {lesson.language}
                            </div>
                            <div className={`text-xs p-1 border max-w-full truncate ${handleLessonDifficultyColor(lesson.lesson_difficulty, 'other')} rounded-xl`}>
